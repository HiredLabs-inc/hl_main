...
from .models import Participant, Interaction, Job, Phase, Step, KeywordAnalysis, ParticipantExperience, \
    ParticipantOverview, WeightedBullet, BulletKeyword, ParticipantEducation, Applicant, State
...
class ApplicantAdmin(admin.ModelAdmin):
    list_display = ('name', 'email', 'phone', 'location', 'service_branch', 'rank_at_separation')
    list_filter = ('name', 'email', 'phone', 'location', 'service_branch', 'rank_at_separation')
    search_fields = ('name', 'email', 'phone', 'location', 'service_branch', 'rank_at_separation')
