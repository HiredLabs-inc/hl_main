...
from .models import Participant, Interaction, Experience, Applicant
...
class ApplicantForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'special_training': forms.Textarea(attrs={
                'rows': 3,
                'class': 'form-control',
            ...
            'job_links': forms.Textarea(attrs={
                'rows': 3,
                'class': 'form-control',
                'placeholder': 'Please list links to 2-3 job posts that interest you.'
            }),
            'work_preferences': forms.Textarea(attrs={
                'rows': 3,
                'class': 'form-control',
