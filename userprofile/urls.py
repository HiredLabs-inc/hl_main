...
urlpatterns = [
    ...
    path(
        "logout/",
        auth_views.LogoutView.as_view(template_name="userprofile/logout.html"),
        name="logout",
    ),
    path(
        "password_change/",
    ...
    path(
        "register_veteran_status/",
        views.register_veteran_status,
        name="register_veteran_status",
    ),
    path(
        "register_user_info/",
        views.register_user_info,
